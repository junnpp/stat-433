...
```{r}
# arrows
countries = c("United States", "China", "Japan", "Canada", "India", "United Kingdom", "World")
...
africa = df %>%
    ...
    xlab("P10") + 
    ylab("P90") +
    scale_colour_manual(values=c(Africa="red", Other="gray"), name = "")

eur = df %>%
    ggplot() + 
    geom_point(aes(x=p10, y=p90, color = "Other"), alpha = 0.6) + 
    geom_point(data = subset(df, continent == "Europe"),
               aes(x=p10, y=p90, color = "Europe"), alpha = 0.6) + 
    geom_abline(intercept = 0, slope = 1, color = "black", lty = "dashed", alpha = 0.6) +
    annotate('text', x=4.5, y=3, label = "1:1", color = "gray") + 
    geom_abline(intercept = 1, slope = 1, color = "black", lty = "dashed", alpha = 0.6) +
    annotate('text', x=5.5, y=100, label = "10:1", color = "gray") + 
    ...
    xlab("P10") + 
    ylab("P90") +
    scale_colour_manual(values=c(Europe="red", Other="gray"), name = "")

asia = df %>%
    ggplot() + 
    geom_point(aes(x=p10, y=p90, color = "Other"), alpha = 0.6) + 
    geom_point(data = subset(df, continent == "Asia"),
               aes(x=p10, y=p90, color = "Asia"), alpha = 0.6) + 
    geom_abline(intercept = 0, slope = 1, color = "black", lty = "dashed", alpha = 0.6) +
    annotate('text', x=4.5, y=3, label = "1:1", color = "gray") + 
    geom_abline(intercept = 1, slope = 1, color = "black", lty = "dashed", alpha = 0.6) +
    annotate('text', x=5.5, y=100, label = "10:1", color = "gray") + 
    ...
    xlab("P10") + 
    ylab("P90") +
    scale_colour_manual(values=c(Asia="red", Other="gray"), name = "")

oce = df %>%
    ggplot() + 
    geom_point(aes(x=p10, y=p90, color = "Other"), alpha = 0.6) + 
    geom_point(data = subset(df, continent == "Oceania"),
               aes(x=p10, y=p90, color = "Oceania"), alpha = 0.6) + 
    geom_abline(intercept = 0, slope = 1, color = "black", lty = "dashed", alpha = 0.6) +
    annotate('text', x=4.5, y=3, label = "1:1", color = "gray") + 
    geom_abline(intercept = 1, slope = 1, color = "black", lty = "dashed", alpha = 0.6) +
    annotate('text', x=5.5, y=100, label = "10:1", color = "gray") + 
    ...
    xlab("P10") + 
    ylab("P90") +
    scale_colour_manual(values=c(Oceania="red", Other="gray"), name = "")

na = df %>%
    ggplot() + 
    geom_point(aes(x=p10, y=p90, color = "Other"), alpha = 0.6) + 
    geom_point(data = subset(df, continent == "North America"),
               aes(x=p10, y=p90, color = "North America"), alpha = 0.6) + 
    geom_abline(intercept = 0, slope = 1, color = "black", lty = "dashed", alpha = 0.6) +
    annotate('text', x=4.5, y=3, label = "1:1", color = "gray") + 
    geom_abline(intercept = 1, slope = 1, color = "black", lty = "dashed", alpha = 0.6) +
    annotate('text', x=5.5, y=100, label = "10:1", color = "gray") + 
    ...
    xlab("P10") + 
    ylab("P90") +
    scale_colour_manual(values=c(`North America`="red", Other="gray"), name = "")

sa = df %>%
    ggplot() + 
    geom_point(aes(x=p10, y=p90, color = "Other"), alpha = 0.6) + 
    geom_point(data = subset(df, continent == "South America"),
               aes(x=p10, y=p90, color = "South America"), alpha = 0.6) + 
    geom_abline(intercept = 0, slope = 1, color = "black", lty = "dashed", alpha = 0.6) +
    annotate('text', x=4.5, y=3, label = "1:1", color = "gray") + 
    geom_abline(intercept = 1, slope = 1, color = "black", lty = "dashed", alpha = 0.6) +
    annotate('text', x=5.5, y=100, label = "10:1", color = "gray") + 
    ...
    xlab("P10") + 
    ylab("P90") +
    scale_colour_manual(values=c(`South America`="red", Other="gray"), name = "")

(africa + asia) / (eur + oce ) / (na + sa)
```

### Other Datasets?
```{r}
gini_df = owid("economic-inequality-gini-index")
gini_df

owid_search("income inequality")

# death-rate
death_rate_df = owid("death-rate-from-cancers-vs-income-inequality")

# anxiety disorders
anxiety_df = owid("anxiety-disorders-vs-income-inequality")

# suicide rate
suicide_df = owid("suicide-rate-vs-income-inequality")

# interpersonal trust 
trust_df = owid("interpersonal-trust-vs-income-inequality")
``` 
...
death_rate_df = death_rate_df %>%
    rename(
      "country" = "entity",
      "rate" = "Deaths - Neoplasms - Sex: Both - Age: Age-standardized (Rate)",
