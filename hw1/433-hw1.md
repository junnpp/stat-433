...
**Q1. How many flights have a missing `dep_time`? What other variables
...
**Q2. Currently `dep_time` and `sched_dep_time` are convenient to look
...
**Q3. Look at the number of cancelled flights per day. Is there a
